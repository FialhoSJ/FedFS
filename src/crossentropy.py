...
def get_features_ce(X, Y, init_probability=[0.5], classes=2, selection_percentile=10, selection_probability=0.90, max_sample_ce=100, max_steps_ce=10, alpha=1, epsilon_tolerance=1e-5, current_step=1, subsample_perc=-1, alpha_step=0, verbose=False, early_stop=False,njobs=2):
